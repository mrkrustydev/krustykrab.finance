import { KRUSTY_PER_BLOCK } from 'config/index'
...
const pools: PoolConfig[] = [
  {
    sousId: 0,
    tokenName: 'KRUSTY',
    stakingTokenName: QuoteToken.KRUSTY,
    stakingTokenAddress: contracts.krusty[chainId],
    contractAddress: {
      97: contracts.mrKrabs[97],
      56: contracts.mrKrabs[56], // contracts.mrKrabs[56],
    },
    poolCategory: PoolCategory.CORE,
    projectLink: 'https://thekrustykrab.finance/',
    harvest: true,
    tokenPerBlock: KRUSTY_PER_BLOCK.toString(),
    sortOrder: 1,
    isFinished: false,
    tokenDecimals: 18,
  }
  /*
  {
    ...
    poolCategory: PoolCategory.CORE,
    projectLink: 'https://thecaffe.finance/',
    harvest: true,
    tokenPerBlock: '10',
    sortOrder: 10,
    isFinished: false,
