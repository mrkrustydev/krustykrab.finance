...
import { Button, Flex, Text } from '../../../../pancake-uikit/src'
...
const CardActions: React.FC<FarmCardActionsProps> = ({ farm, ethereum, account, addLiquidityUrl }) => {
  ...
  const { tokenAddresses, isSingleAsset, depositFee } = useFarmFromPid(farm.pid)
  ...
  }, [ethereum, lpAddress, isSingleAsset, tokenAddress])
