...
import { Text, Heading, BaseLayout, Button, LinkExternal, Flex, Image } from '../../pancake-uikit/src'
    ...
    <div>
      ...
      <LaunchIfoCallout>
        <div>
          ...
          <List>
            <li>{TranslateString(596, 'Buy KRUSTY and BNB tokens')}</li>
            <li>{TranslateString(598, 'Get KRUSTY-BNB LP tokens by adding KRUSTY and BNB liquidity')}</li>
          </List>
          <Flex mb="16px">
            <LinkExternal href="https://exchange.pancakeswap.finance/#/swap" mr="16px">
              {TranslateString(999, 'Buy KRUSTY')}
            </LinkExternal>
          ...
          <List>
            <li>{TranslateString(602, 'While the sale is live, commit your KRUSTY-LP tokens to buy the IFO tokens')}</li>
          </List>
        ...
        <div>
          ...
          <div>
            ...
            <Text mb={3}>
              {TranslateString(
                514,
                'Launch your project with TheCaffe, Binance Smart Chain’s most-used AMM project and liquidity provider, to bring your token directly to the most active and rapidly growing community on BSC.',
              )}
            </Text>
            <Button
              as="a"
