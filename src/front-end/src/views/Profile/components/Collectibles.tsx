...
import { Heading, Text, Flex, ChevronRightIcon } from '../../../pancake-uikit/src'
  ...
  return (
    <>
      ...
      <Text as="p">
        {TranslateString(
          999,
          'Pancake Collectibles are special ERC-721 NFTs that can be used on the TheCaffe platform.',
        )}
      </Text>
      <Text as="p">
        {TranslateString(
